...
statusupdate_link = StatusUpdate.new(user_id: chloe.id, title: "Next Surgery", content: "Hi all, as most of you know. I have a big sugery coming up. Keep your fingers crossed next Friday!! You probably have a lot of questions, which I try to answer in this update. A splenectomy is surgery to remove the entire <a href='#' id='showcase-link'>spleen</a>. The <a href='#' id='showcase-link'>spleen</a> is an important part of the body's defense (immune) system. It contains special white blood cells that destroy bacteria and help the body fight infections when you are sick. It also helps remove, or filter, old red blood cells from the body's circulation. If only part of the <a href='#' id='showcase-link'>spleen</a> is removed, the procedure is called a partial splenectomy. Unlike some other organs, like the liver, the <a href='#' id='showcase-link'>spleen</a> does not grow back (regenerate) after it is removed.", remote_photo_url: "https://res.cloudinary.com/dd9qabk1u/image/upload/v1567725630/sava/photo-1514416309827-bfb0cf433a2d_eavcjn.jpg", created_at: "Fri, 06 Sep 2019 09:40:56 UTC +00:00")
